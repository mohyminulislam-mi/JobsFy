  ...
  const users = [
    {
      ...
      msg: "That sounds great! When are you free?",
      time: "10:42 AM",
      unread: 2,
      online: true,
      img: 12,
    ...
    {
      id: 2,
      name: "TechCorp Eng Team",
      role: "Group Chat",
      msg: "Anna: Could you share the latest...",
      time: "Yesterday",
      unread: 0,
      online: false,
      img: 21,
    ...
    },
    {
      ...
      msg: "Are you open to freelance work?",
      time: "Monday",
      unread: 0,
      online: false,
      img: 45,
    },
    {
      ...
      name: "David Miller",
      role: "Hiring Manager",
      msg: "Lets schedule a quick 15 min call.",
      time: "Monday",
      unread: 0,
      online: true,
      img: 55,
        ...
        <div className="w-full md:w-1/3 lg:w-1/4 bg-white rounded-2xl shadow-soft border border-gray-100 flex flex-col h-full overflow-hidden shrink-0">
          ...
          <div className="overflow-y-auto flex-grow scrollbar-hide">
            {users.map((user) => (
              <div
                key={user.id}
                className={`p-4 border-b border-gray-50 flex gap-3 cursor-pointer transition-colors ${user.id === 1 ? "bg-primary-50 border-l-4 border-l-primary-600" : "hover:bg-gray-50"}`}
              >
                ...
                <div className="flex-grow min-w-0">
                  <div className="flex justify-between items-baseline mb-0.5">
                    ...
                    <span
                      className={`text-xs whitespace-nowrap ${user.unread > 0 ? "text-primary-600 font-bold" : "text-gray-400"}`}
                    >
                      {user.time}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    <p
                      className={`text-sm truncate pr-2 ${user.unread > 0 ? "text-gray-900 font-semibold" : "text-gray-500"}`}
                    >
                      {user.msg}
                    </p>
                    {user.unread > 0 && (
        ...
        <div className="hidden md:flex flex-col flex-grow bg-white rounded-2xl shadow-soft border border-gray-100 overflow-hidden relative">
          ...
          <div className="flex-grow p-6 overflow-y-auto flex flex-col gap-6 custom-scrollbar scrollbar-hide bg-gray-50/50">
            <div className="text-center">
              <span className="bg-gray-100 text-gray-500 px-3 py-1 text-xs rounded-full font-medium">
                Yesterday
              </span>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-1 items-start max-w-[75%]">
                <div className="bg-white text-gray-800 p-3.5 rounded-2xl rounded-bl-sm border border-gray-100 shadow-sm text-sm">
                  Hi there! We reviewed your application for the Senior Frontend
                  Engineer role and we were very impressed.
                </div>
            ...
            <div className="flex gap-4 flex-row-reverse relative group">
              <div className="flex flex-col gap-1 items-end max-w-[75%]">
                <div className="bg-primary-600 text-white p-3.5 rounded-2xl rounded-br-sm shadow-md text-sm">
                  Thank you, Jessica! I'm really excited about the opportunity
                  to join the team.
                </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-1 items-start max-w-[75%]">
                <div className="bg-white text-gray-800 p-3.5 rounded-2xl rounded-bl-sm border border-gray-100 shadow-sm text-sm">
                  That sounds great! When are you free for a technical interview
                  next week?
                </div>
